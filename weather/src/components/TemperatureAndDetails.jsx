...
function TemperatureAndDetails({weather: {temp, feels_like, temp_min, temp_max,
    humidity,sunrise, sunset, details, icon, timezone,speed}}) {
  return (
    <div>
        ...
        <div className='flex flex-row items-center justify-between py-3 text-white'>
            ...
            <div className='flex flex-col space-y-2'>
                <div className='flex font-light text-sm items-center
                    justify-center'>
                        <UilTemperature siize={18} className="mr-1"/>
                        Feels like: 
                        <span className='font-medium ml-1'>{`${feels_like.toFixed()}°`}</span>
                </div>
                <div className='flex font-light text-sm items-center
                    justify-center'>
                        <UilWind siize={18} className="mr-1"/>
                        Wind: 
                        <span className='font-medium ml-1'>{`${speed.toFixed()} km/h`}</span>
                </div>
                <div className='flex font-light text-sm items-center
                    justify-center'>
                        <UilTear siize={18} className="mr-1"/>
                        Humidity: 
